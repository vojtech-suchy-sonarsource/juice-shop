...
export default defineConfig({
  ...
  e2e: {
    ...
    setupNodeEvents (on: any) {
      on('before:browser:launch', (launchOptions: any, browser: any = {}) => { // TODO Remove after upgrade to Cypress >=12.5.0 <or> Chrome 119 become available on GitHub Workflows, see https://github.com/cypress-io/cypress-documentation/issues/5479
